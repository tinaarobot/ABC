...
def welcomepic(pic, user, chat, id, uname):
    ...
    draw.text((95, 250), f'NAME : {unidecode(user)}', fill="black", font=font)
    draw.text((135, 340), f'ID : {id}', fill="black", font=font)
    draw.text((125, 430), f"USERNAME : {uname}", fill="black",font=font)
    pfp_position = (807, 140)  
